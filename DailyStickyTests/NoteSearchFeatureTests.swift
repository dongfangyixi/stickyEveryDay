    ...
    func testEverySupportedLanguageHasCoreTranslationsAndLocalizedDateOrder() {
        ...
        for language in AppLanguage.allCases {
            ...
            for key in [
                ...
                "Use the arrow buttons or press Return for the next match and Shift-Return for the previous match. Escape clears the query first, then closes Find.",
                "Find text in images",
                "Go to any note",
                "Press Cmd-P to search every day by note content, recognized image text, or date. Use Up and Down, then Return to open a result.",
                "Search by date",
                "Type a date such as Aug 12 or 12 Aug. Dates follow the language selected in Settings, and note text supports fuzzy matching across Latin and CJK text.",
                "Open the exact match",
                "Opening a content result starts Find in that note and scrolls to the matching text. Use Return and Shift-Return for other matches.",
                "Return to your day",
                "Link",
                "Nested lists",
                "Tab moves a todo, bullet, or numbered item in one level. Shift-Tab moves it back out. With multiple lines selected, every selected line moves together.",
                "Filter commands",
                "Keep typing after / to focus the closest command, such as /todo, /heading, /bullet, or /divider.",
                "Copy an image",
                "Select the image and press Cmd-C, or right-click it and choose Copy.",
                "Select recognized text",
                "Select an image, then drag across recognized text to copy only those characters. Use the text-recognition button to show or hide recognition boxes.",
                "Change code language",
                "Click the language chip in a code block to choose syntax highlighting or enter another Markdown language identifier.",
                "Choose Local only to keep everything on this Mac, or Sync with iCloud to share notes, task states, and pasted images across Macs using the same iCloud account. Pinaday keeps a local offline copy either way.",
                "Choose the app language in Settings. Dates, controls, Quick Start, and Help update immediately.",
                "Drag the date dial to move through days, or click a visible date to jump to it.",
                "When today moves off the dial, select the Today marker at the edge to return.",
                "Paste images directly to the note.",
                "Paste with Cmd-V. Select an image and use Cmd-C to copy it, or drag over its automatically recognized text to copy the words."
            ] {
                XCTAssertNotEqual(
